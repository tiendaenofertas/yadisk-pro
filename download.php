...
$downloadToken = bin2hex(random_bytes(32)); // 32 bytes = 64 caracteres hex
$_SESSION['download_token_' . $downloadToken] = $videoId;

// Token expira en 10 minutos
$_SESSION['download_token_expiry_' . $downloadToken] = time() + 600;
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<body>
    ...
    <script>
        ...
        // Configuración del contador (aumentado a 10 segundos)
        const duration = 10;
        let currentTime = 0;
        ...
        const token = '<?php echo htmlspecialchars($downloadToken, ENT_QUOTES, 'UTF-8'); ?>';
        ...
        function enableDownload() {
            ...
            const downloadUrl = 'direct-download.php?token=' + encodeURIComponent(token);
        ...
        function startDownload() {
            ...
            setTimeout(() => {
                ...
                try {
                    ...
                    // Ignorar errores si el iframe ya fue removido
                }
                
                // Resaltar el botón alternativo
                fallbackBtn.style.animation = 'pulse 1s infinite';
            }, 5000);
        }

        // Prevenir recarga de página durante el contador
